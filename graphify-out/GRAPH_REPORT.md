...
## Corpus Check
- 350 files · ~189,317 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2997 nodes · 8360 edges · 153 communities (132 shown, 21 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1132 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78801878`
...
Cohesion: 0.13
Nodes (25): BrokerCredentialService, Logger, Service, TradingMode, LIVE, PAPER, EntryOrderType, LIMIT (+17 more)
...
Cohesion: 0.22
Nodes (10): FakeAlpacaTradingServer, FakeOrder, ClientHttpRequest, ClientHttpResponse, HttpStatus, ObjectMapper, RestClient, BeforeEach (+2 more)
...
Cohesion: 0.20
Nodes (4): IndicatorWeights, WeightedVoteRuleEngine, Test, WeightedVoteRuleEngineTest
...
Cohesion: 0.17
Nodes (6): MathContext, RsiCalculator, MathContext, VolatilityCalculator, VolumeTrendCalculator, HoldTermCalculator
...
Cohesion: 0.22
Nodes (19): general-purpose agent (implementation), guardrail-check skill, security-review skill, simplify skill, F1.3 Secrets & config management, E1-F3-S1 Broker API keys encrypted at rest, E1-F3-S2 Dashboard requires login, E5 — Auto-Trade Execution (+11 more)
...
Cohesion: 0.12
Nodes (8): Entity, Override, PrePersist, Table, WatchlistEntry, Query, WatchlistEntryRepository, Transactional
...
### Community 52 - "Candle"
Cohesion: 0.06
Nodes (22): MacdResult, MathContext, MacdCalculator, MathContext, MovingAverageResult, MovingAverageCrossoverCalculator, Candle, FixtureSplits (+14 more)
...
### Community 67 - "Broker"
Cohesion: 0.09
Nodes (13): Broker, ALPACA, BINANCE, BrokerAccountStatus, BrokerAdapterAmbiguousOrderException, BrokerAdapterException, BrokerAdapterRateLimitedException, BrokerAdapterTransientException (+5 more)

### Community 68 - "Ticker"
Cohesion: 0.09
Nodes (13): Autowired, BrokerPosition, AssetType, CRYPTO, STOCK, Entity, Override, PrePersist (+5 more)
...
Cohesion: 0.28
Nodes (7): IndicatorResponse, MovingAverageRelation, EQUAL, SHORT_ABOVE_LONG, SHORT_BELOW_LONG, TickerSummary, SignalResponse
...
### Community 83 - "TickerNotRegisteredException"
Cohesion: 0.21
...
### Community 86 - "CoreDataModelIntegrationTest.java"
Cohesion: 0.24
Nodes (6): TickerRepository, CoreDataModelIntegrationTest, SpringBootTest, Test, Transactional, EntityManager
...
Cohesion: 0.12
Nodes (10): Pageable, Query, OrderRepository, Logger, Service, OrderService, SignalCallEntryRepository, Service (+2 more)
...
Cohesion: 0.14
Nodes (10): Checkpoint, MAX, MID, MIN, CheckpointStats, DirectionalOutcomeStats, CheckpointDrift, CheckpointStatsTest (+2 more)

### Community 106 - ".run"
Cohesion: 0.12
Nodes (11): Candle, BacktestHarness, HoldGateAccumulator, FunctionalInterface, RuleEvaluator, BacktestHarnessTest, Test, HoldGateOutcome (+3 more)
...
Cohesion: 0.09
Nodes (19): PerSymbolRuleThresholds, RuleThresholds, SignalRuleEngine, SignalRuleId, BEARISH_MAJORITY, BEARISH_UNANIMOUS, BULLISH_MAJORITY, BULLISH_UNANIMOUS (+11 more)

### Community 125 - "SignalCallEntry"
Cohesion: 0.11
Nodes (13): AuditEntryResponse, JsonInclude, HoldTerm, SignalCall, BUY, HOLD, SELL, Entity (+5 more)
...
### Community 127 - "MarketDataExceptionHandler.java"
Cohesion: 0.20
...
### Community 142 - "OrderAuditEntryRepository"
Cohesion: 0.43
...
Cohesion: 0.13
Nodes (11): BigDecimalIndicators, MacdResult, MovingAverageResult, AutoConfigureMockMvc, MockMvc, Test, WebMvcTest, SignalControllerTest (+3 more)
...
## Knowledge Gaps
- **279 isolated node(s):** `com.autotrade.dashboard:backend`, `MIN`, `MID`, `MAX`, `WIN` (+274 more)
...
- **Why does `Candle` connect `Candle` to `ThresholdCalibrationTest`, `AlpacaMarketDataClient`, `IndicatorId`, `.calculate`, `BinanceMarketDataClient`, `PerSymbolRsiOverboughtCalibrationTest`, `RegimeClassifier`, `.getChartData`, `BacktestHarness.java`, `SignalServiceTest`, `LiveSignalDriftServiceTest`, `LiveDriftBaselineTest.java`, `Broker`, `Ticker`, `LiveSignalDriftService.java`, `OrderServiceTest.java`, `.getPriceHistory`, `MacdHistogramMagnitudeCalibrationTest`, `.findFirstCrossing`, `DirectionalOutcomeStats`, `.run`, `BacktestReport`, `StockPerSymbolRsiOverboughtCalibrationTest`, `IndicatorService`, `.findRegistered`, `SignalRuleId`, `SignalCallEntry`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `TradingMode` connect `TradingMode` to `BrokerOrderRequest`, `BinanceFuturesTradingAdapter`, `AlpacaTradingAdapter`, `Order`, `TradingModeResponse`, `BrokerCredentialServiceFindTest.java`, `BrokerAdapterContractTest`, `AlpacaTradingAdapterContractTest`, `BinanceFuturesTradingAdapterContractTest`, `RetryingAlpacaTradingAdapterContractTest`, `BrokerCredential`, `RetryingBinanceFuturesTradingAdapterContractTest`, `TradingModeServiceTest`, `MockBrokerAdapterContractTest`, `OrderQueryControllerTest`, `.readDecrypted`, `RetryingMockBrokerAdapterContractTest`, `TradingModeEvent`, `.run`, `OrderServiceTest`, `RetryingBrokerAdapter`, `TradingModeController`, `BrokerAdapterConfig.java`, `BinanceFuturesAdapterConfig.java`, `BrokerOrderResult`, `Broker`, `Ticker`, `OrderServiceTest.java`, `.getAccountStatus`, `CoreDataModelIntegrationTest.java`, `.placeOrder`, `TradingModeService`, `OrderService`, `SignalCallEntry`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `SignalRuleId` connect `SignalRuleId` to `.evaluate`, `ThresholdCalibrationTest`, `OrderServiceTest.java`, `.calculate`, `BacktestHarness.java`, `IndicatorId`, `BacktestReport`, `Test`, `MacdHistogramMagnitudeCalibrationTest`, `MovingAverageResult`, `.evaluate`, `PerSymbolRsiOverboughtCalibrationTest`, `StockPerSymbolRsiOverboughtCalibrationTest`, `SignalCallEntry`?**
