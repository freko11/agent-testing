...
## Corpus Check
- 347 files · ~181,460 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2959 nodes · 8233 edges · 160 communities (133 shown, 27 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1116 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6cffc922`
...
Cohesion: 0.10
Nodes (10): CrossingEvent, WalkForwardScorer, Entity, Override, PrePersist, Table, OrderAuditEntry, BacktestHarnessTpSlTest (+2 more)

### Community 9 - "TradingMode"
Cohesion: 0.13
Nodes (24): BrokerCredentialService, Logger, Service, TradingMode, LIVE, PAPER, EntryOrderType, LIMIT (+16 more)
...
Cohesion: 0.09
Nodes (11): BrokerCredential, Entity, Override, PrePersist, PreUpdate, Table, BrokerCredentialRepository, SpringBootTest (+3 more)
...
Cohesion: 0.21
Nodes (4): IndicatorWeights, MovingAverageResult, Test, WeightedVoteRuleEngineTest
...
### Community 40 - "BacktestReport.java"
Cohesion: 0.15
Nodes (6): RegimeClassifier, Test, PerSymbolAdxTrendingThresholdCalibrationTest, SymbolFixture, Test, RegimeOutOfSampleValidationTest

### Community 41 - "Ticker"
Cohesion: 0.10
Nodes (11): Entity, Override, PrePersist, Table, Ticker, TickerRepository, CoreDataModelIntegrationTest, SpringBootTest (+3 more)
...
Cohesion: 0.19
Nodes (9): IndicatorComputation, MovingAverageResult, IndicatorFactory, BeforeEach, ExtendWith, FunctionalInterface, IndicatorResponse, Test (+1 more)
...
### Community 67 - "Broker"
Cohesion: 0.09
Nodes (12): Broker, ALPACA, BINANCE, BrokerAccountStatus, BrokerAdapterAmbiguousOrderException, BrokerAdapterException, BrokerAdapterRateLimitedException, BrokerAdapterTransientException (+4 more)

### Community 68 - "AssetType"
Cohesion: 0.15
Nodes (9): BrokerPosition, JsonInclude, OrderResponse, AssetType, CRYPTO, STOCK, SpringBootTest, Transactional (+1 more)
...
Cohesion: 0.15
Nodes (14): Autowired, IndicatorResponse, MovingAverageRelation, EQUAL, SHORT_ABOVE_LONG, SHORT_BELOW_LONG, TickerSummary, KillSwitchCancelSummary (+6 more)

### Community 72 - ".getPriceHistory"
Cohesion: 0.23
Nodes (6): MarketClosedException, PriceHistoryResult, IndicatorServiceTest, BeforeEach, ExtendWith, Test
...
### Community 75 - "RuleThresholds"
Cohesion: 0.12
Nodes (9): PerSymbolRuleThresholds, RuleThresholds, SignalRuleEngine, Test, MacdHistogramMagnitudeCalibrationTest, SymbolFixture, Test, MaCrossoverSeparationCalibrationTest (+1 more)
...
Cohesion: 0.03
Nodes (76): Changelog, Dark-first premium visual pass, E1-F1-S1 — local Oracle XE via Docker Compose, E1-F1-S2 — Spring Boot backend skeleton, E1-F1-S3 — React app skeleton, E1-F1-S4 — CI pipeline, E1-F1-S5 — env/config profiles, E1-F2 — core data model (+68 more)

### Community 83 - "BacktestHarness.java"
Cohesion: 0.15
Nodes (8): MacdResult, MathContext, MacdCalculator, MathContext, RsiCalculator, VolumeTrendCalculator, Test, MacdCalculatorTest
...
Cohesion: 0.10
Nodes (13): BrokerAdapter, BrokerAdapterRouter, Service, Pageable, Query, OrderRepository, Logger, Service (+5 more)
...
### Community 106 - "IndicatorId"
Cohesion: 0.17
Nodes (8): IndicatorId, MA_CROSSOVER, MACD, RSI, Candle, BacktestHarnessTest, Test, Test

### Community 107 - "DirectionalOutcomeStats"
Cohesion: 0.14
Nodes (6): DirectionalOutcomeStats, BacktestReport, HoldGateStats, RegimeSplitStats, Test, RsiOverboughtRecalibrationTest
...
Cohesion: 0.22
Nodes (9): IndicatorService, Service, IndicatorSnapshotRepository, GetMapping, RequestMapping, RestController, MarketDataController, Service (+1 more)

### Community 120 - "TickerService"
Cohesion: 0.14
Nodes (10): MarketDataClient, Component, MarketHoursService, Service, Transactional, TickerService, BeforeEach, ExtendWith (+2 more)
...
Cohesion: 0.13
Nodes (8): AuditEntryResponse, JsonInclude, HoldTerm, Entity, Override, PrePersist, Table, SignalCallEntry
...
### Community 133 - "FakeAlpacaTradingServer"
Cohesion: 0.32
...
Cohesion: 0.14
Nodes (9): DecryptedCredential, Override, AlpacaTradingAdapterContractTest, BeforeEach, ExtendWith, Override, BeforeEach, RestClient (+1 more)
...
### Community 148 - "MacdResult"
Cohesion: 0.20
Nodes (4): BigDecimalIndicators, MacdResult, WeightedVoteRuleEngine, MacdResult

### Community 151 - "CredentialEncryptionService"
Cohesion: 0.39
...
### Community 159 - ".setUpAdapter"
Cohesion: 0.33
Nodes (3): BeforeEach, RestClient, BeforeEach

## Knowledge Gaps
- **273 isolated node(s):** `com.autotrade.dashboard:backend`, `MIN`, `MID`, `MAX`, `WIN` (+268 more)
...
- **Why does `Candle` connect `Candle` to `ThresholdCalibrationTest`, `AlpacaMarketDataClient`, `OutOfSampleValidationTest`, `OrderAuditEntry`, `WeightedVoteBacktestTest`, `.calculate`, `.calculate`, `BinanceMarketDataClient`, `MacdResult`, `PerSymbolRsiOverboughtCalibrationTest`, `RsiOversoldRecalibrationTest`, `.calculate`, `.calculate`, `RegimeCalibrationTest`, `TickerNotRegisteredException`, `.getChartData`, `BacktestReport.java`, `Ticker`, `LiveSignalDriftService.java`, `Checkpoint`, `Broker`, `.calculate`, `.run`, `OrderServiceTest.java`, `.getPriceHistory`, `RuleThresholds`, `LiveSignalDriftServiceTest`, `BacktestHarness.java`, `CheckpointStats`, `IndicatorId`, `DirectionalOutcomeStats`, `IndicatorService`, `TickerService`, `SignalCallEntry`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `BrokerCredentialService` connect `TradingMode` to `BinanceFuturesTradingAdapter`, `AlpacaTradingAdapter`, `AlpacaTradingAdapterContractTest`, `BinanceFuturesTradingAdapterContractTest`, `RetryingAlpacaTradingAdapterContractTest`, `BrokerCredential`, `RetryingBinanceFuturesTradingAdapterContractTest`, `BrokerCredentialServiceFindTest.java`, `.readDecrypted`, `CredentialEncryptionService`, `.run`, `OrderServiceTest`, `Ticker`, `security-review skill`, `BrokerAdapterConfig.java`, `BinanceFuturesAdapterConfig.java`, `Broker`, `AssetType`, `OrderServiceTest.java`, `OrderService`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `TradingMode` connect `TradingMode` to `BrokerOrderRequest`, `BinanceFuturesTradingAdapter`, `AlpacaTradingAdapter`, `Order`, `.switchTo`, `BrokerAdapterContractTest`, `AlpacaTradingAdapterContractTest`, `BinanceFuturesTradingAdapterContractTest`, `RetryingAlpacaTradingAdapterContractTest`, `BrokerCredential`, `RetryingBinanceFuturesTradingAdapterContractTest`, `TradingModeServiceTest`, `MockBrokerAdapterContractTest`, `BrokerCredentialServiceFindTest.java`, `OrderQueryControllerTest`, `.readDecrypted`, `RetryingMockBrokerAdapterContractTest`, `TradingModeEvent`, `.run`, `OrderServiceTest`, `Ticker`, `RetryingBrokerAdapter`, `.getAccountStatus`, `TradingModeResponse`, `BrokerAdapterConfig.java`, `BinanceFuturesAdapterConfig.java`, `BrokerOrderResult`, `Broker`, `AssetType`, `OrderServiceTest.java`, `.placeOrder`, `TradingModeService`, `OrderService`, `SignalCallEntry`?**
