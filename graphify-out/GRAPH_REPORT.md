# Graph Report - agent-a02e855af8406704c  (2026-08-11)

## Corpus Check
- 344 files · ~175,439 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2919 nodes · 8134 edges · 141 communities (121 shown, 20 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1112 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3da79f31`
...
Cohesion: 0.06
Nodes (18): AssetBalance, BrokerAccountStatus, BrokerAdapterRetryPolicy, Logger, Override, RetryingBrokerAdapter, BrokerAdapterRouterTest, Test (+10 more)

### Community 1 - "BinanceFuturesTradingAdapterTest"
Cohesion: 0.12
Nodes (7): Credentials, Override, BrokerOrderRequest, BinanceFuturesTradingAdapterTest, ExtendWith, MockRestServiceServer, Test

### Community 2 - ".placeOrder"
Cohesion: 0.16
...
Cohesion: 0.05
Nodes (18): CrossingEvent, WalkForwardScorer, Entity, Override, PrePersist, Table, OrderAuditEntry, OrderCsvExporter (+10 more)
...
Cohesion: 0.08
Nodes (16): Page, PagedResponse, Page, Pageable, Query, GetMapping, PostMapping, RequestMapping (+8 more)
...
### Community 25 - "TickerService"
Cohesion: 0.15
Nodes (11): Service, Transactional, TickerService, Service, Transactional, WatchlistEntry, WatchlistService, SpringBootTest (+3 more)
...
Cohesion: 0.08
Nodes (26): DecryptedCredential, Override, BeforeEach, BinanceFuturesTradingAdapterContractTest, BeforeEach, ExtendWith, Override, FakeAlpacaTradingServer (+18 more)
...
Cohesion: 0.17
Nodes (8): BigDecimalIndicators, IndicatorService, Service, InvalidIndicatorRequestException, GetMapping, RequestMapping, RestController, SignalController
...
Cohesion: 0.14
Nodes (8): ChartDataResponse, ChartIndicatorPoint, TickerNotRegisteredException, IndicatorControllerTest, AutoConfigureMockMvc, MockMvc, Test, WebMvcTest
...
Cohesion: 0.13
Nodes (7): RegimeClassifier, Test, RegimeCalibrationTest, Test, RegimeOutOfSampleValidationTest, Test, RegimeClassifierTest

### Community 41 - "BinanceFuturesTradingAdapter"
Cohesion: 0.10
...
Cohesion: 0.15
Nodes (8): NotificationRepository, Logger, Service, NotificationService, BeforeEach, ExtendWith, Test, NotificationServiceTest
...
### Community 47 - "AlpacaTradingAdapter"
Cohesion: 0.11
...
### Community 49 - "SignalServiceTest"
Cohesion: 0.19
...
### Community 52 - "Candle"
Cohesion: 0.05
Nodes (27): MacdResult, MathContext, MacdCalculator, MathContext, MovingAverageResult, MovingAverageCrossoverCalculator, MathContext, RsiCalculator (+19 more)
...
Cohesion: 0.22
Nodes (6): BrokerCredentialRepository, CoreDataModelIntegrationTest, SpringBootTest, Test, Transactional, EntityManager
...
Cohesion: 0.20
Nodes (9): NotificationType, ORDER_CANCELLED, ORDER_FAILED, ORDER_FILLED, ORDER_PARTIALLY_FILLED, ORDER_PARTIALLY_PROTECTED, ORDER_REJECTED, ORDER_SUBMISSION_UNKNOWN (+1 more)

### Community 64 - "BrokerOrderResult"
Cohesion: 0.21
Nodes (5): BrokerAdapter, BrokerAdapterRouter, Service, BrokerOrderResult, KillSwitchCancelSummary
...
### Community 68 - "TickerSignalOrderE2ETest.java"
Cohesion: 0.23
Nodes (5): BrokerPosition, IndicatorSnapshotRepository, SpringBootTest, Transactional, TickerSignalOrderE2ETest

### Community 69 - "TradingMode"
Cohesion: 0.10
Nodes (16): TradingMode, LIVE, PAPER, BrokerCredentialNotConfiguredException, JsonInclude, OrderResponse, OrderStatus, CANCELLED (+8 more)

### Community 70 - ".run"
Cohesion: 0.09
Nodes (17): DirectionalOutcome, LOSS, WASH, WIN, ExitReason, HORIZON_EXPIRED, SL_HIT, TP_HIT (+9 more)

### Community 71 - "OrderServiceTest.java"
Cohesion: 0.12
Nodes (20): IndicatorResponse, MacdResult, MovingAverageRelation, EQUAL, SHORT_ABOVE_LONG, SHORT_BELOW_LONG, MovingAverageResult, TickerSummary (+12 more)
...
### Community 79 - "MarketDataExceptionHandler.java"
Cohesion: 0.20
...
Cohesion: 0.03
Nodes (74): Changelog, Dark-first premium visual pass, E1-F1-S1 — local Oracle XE via Docker Compose, E1-F1-S2 — Spring Boot backend skeleton, E1-F1-S3 — React app skeleton, E1-F1-S4 — CI pipeline, E1-F1-S5 — env/config profiles, E1-F2 — core data model (+66 more)

### Community 83 - "Notification.java"
Cohesion: 0.40
Nodes (3): Entity, PrePersist, Table
...
Cohesion: 0.23
Nodes (6): Autowired, HoldTerm, SpringBootTest, Test, Transactional, OrderAuditEntryRepositoryTest
...
Cohesion: 0.12
Nodes (9): OrderAuditEntryRepository, Pageable, Query, OrderRepository, Logger, Service, OrderService, SignalCallEntryRepository (+1 more)
...
Cohesion: 0.09
Nodes (20): Checkpoint, MAX, MID, MIN, CheckpointStats, DirectionalAccumulator, DirectionalOutcomeStats, DirectionalScoreResult (+12 more)

### Community 107 - "BacktestReport"
Cohesion: 0.14
Nodes (6): BacktestReport, HoldGateStats, Test, RsiOverboughtRecalibrationTest, Test, WeightedVoteBacktestTest
...
Cohesion: 0.09
Nodes (27): AuditEntryResponse, JsonInclude, HoldTermCalculator, IndicatorId, MA_CROSSOVER, MACD, RSI, PerSymbolRuleThresholds (+19 more)
...
## Knowledge Gaps
- **271 isolated node(s):** `com.autotrade.dashboard:backend`, `MIN`, `MID`, `MAX`, `WIN` (+266 more)
...
- **Why does `Candle` connect `Candle` to `ThresholdCalibrationTest`, `AlpacaMarketDataClient`, `OutOfSampleValidationTest`, `SignalCallEntry`, `AssetType`, `.calculate`, `MacdHistogramMagnitudeCalibrationTest`, `BinanceMarketDataClient`, `PerSymbolRsiOverboughtCalibrationTest`, `RsiOversoldRecalibrationTest`, `MarketDataControllerTest.java`, `IndicatorService`, `TickerNotRegisteredException`, `.classify`, `LiveDriftBaselineTest.java`, `.run`, `OrderServiceTest.java`, `.getPriceHistory`, `MaCrossoverSeparationCalibrationTest`, `LiveSignalDriftServiceTest`, `LiveSignalDriftServiceTest.java`, `.runAndVerify`, `DirectionalOutcomeStats`, `BacktestReport`, `MarketDataController`, `MarketDataService`, `SignalRuleId`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `BrokerCredentialService` connect `BrokerCredentialService` to `BinanceFuturesTradingAdapterTest`, `.placeOrder`, `BrokerAdapterContractTest`, `AssetType`, `.run`, `BrokerCredential`, `BrokerCredentialServiceFindTest.java`, `FakeBinanceFuturesTradingServer`, `OrderServiceTest`, `BinanceFuturesTradingAdapter`, `security-review skill`, `AlpacaTradingAdapter`, `CredentialEncryptionService`, `CoreDataModelIntegrationTest.java`, `BrokerAdapterConfig.java`, `BinanceFuturesAdapterConfig.java`, `Broker`, `TickerSignalOrderE2ETest.java`, `OrderServiceTest.java`, `OrderService`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `TradingMode` connect `TradingMode` to `MockBrokerAdapter`, `BinanceFuturesTradingAdapterTest`, `.placeOrder`, `Order`, `TradingModeResponse`, `BrokerAdapterContractTest`, `AssetType`, `.run`, `BrokerCredential`, `TradingModeServiceTest`, `BrokerCredentialServiceFindTest.java`, `OrderQueryControllerTest`, `TradingModeEvent`, `BrokerCredentialService`, `FakeBinanceFuturesTradingServer`, `OrderServiceTest`, `BinanceFuturesTradingAdapter`, `AlpacaTradingAdapter`, `CoreDataModelIntegrationTest.java`, `TradingModeController`, `BrokerAdapterConfig.java`, `BinanceFuturesAdapterConfig.java`, `BrokerOrderResult`, `Broker`, `TickerSignalOrderE2ETest.java`, `OrderServiceTest.java`, `LiveSignalDriftServiceTest.java`, `OrderService`?**
